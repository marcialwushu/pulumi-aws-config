...
using AppsV1 = Pulumi.Kubernetes.Apps.V1;
    ...
    class EksStack : Pulumi.Stack
{
        public Output<string> GenerateKubeconfig(Output<string> clusterEndpoint, Output<string> certData, Output<string> clusterName)
        {
        ...
        public EksStack()
    {
        ...
        var nodeGroup = new Eks.NodeGroup("node-group", new Pulumi.Aws.Eks.NodeGroupArgs
        {
